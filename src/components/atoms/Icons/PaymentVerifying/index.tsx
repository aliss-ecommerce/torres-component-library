...
const PaymentVerifyingIcon: FC<IIcon> = ({ variant, size }) => {
  return (
    <svg
      className={`payment-verifying-icon ${variant && `payment-verifying-icon--${variant}`} ${size && `payment-verifying-icon--${size}`}`}
      viewBox="0 0 48 48"
    >
...
export default PaymentVerifyingIcon;
