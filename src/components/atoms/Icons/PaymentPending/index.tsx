...
const PaymentPendingIcon: FC<IIcon> = ({ variant, size }) => {
  return (
    <svg
      x="0px"
      y="0px"
      viewBox="0 0 50 50"
      className={`payment-pending-icon ${variant && `payment-pending-icon--${variant}`} ${
        size && `payment-pending-icon--${size}`
      }`}
    >
      <g id="Layer_1">
        <path
        ...
        />
        <path
          d="M19,33h-2v2h16v-2h-2v-3.414L26.414,25L31,20.414V17h2v-2H17v2h2v3.414L23.586,25L19,29.586V33z M21,19.586V17h8v2.586
